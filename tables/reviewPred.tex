...
\toprule
Author            & Robot system              & Task                       & Predictor method                         & Camera              & Participants & Delay {[}ms{]} & Task time reduction  \\ \midrule
\cite{Arai2016}          & 6DOF robot arm            & Pick and place             & Robot postion calculation                & Virtual             & 3            & Not reported   & Not reported         \\
\cite{Baldwin1999}       & Stationary camera         & Identify and select shapes & Cropped panoramic video                  & Panoramic 360       & No tests     &                &                      \\
\cite{Bejczy1990}        & 6DOF PUMA robot           & Tapping                    & Superimposed phantom robot               & Fixed               & 2            & 1000, 4000     & 13\%-34\%, 40\%-56\% \\
\cite{Hu2016}            & 2-6 DOF manipulator       & Camera aligment            & Simulated 3D scene                       & Virtual             & 15           & 300, 500, 1000 & 33\%, 58\%, 65\%     \\
\cite{Hu2015}            & 4 wheeled car             & Manouvering                & Image tracking and geometry construction & Fixed to car        & No tests     &                &                      \\
...
\caption{Predictive technology experiments with task time reduction.}
\endgraf\bigskip
\usebox0}}
\end{wraptable}